...
import { Tabs, Tab, Box, TextField, Grid, Autocomplete } from "@mui/material";
...
const NewsManage = () => {
  ...
  const fetchNewsData = useCallback(
    async (data) => {
      const { title, category, startDate, endDate } = data ?? {};
      ...
      try {
        const response = await fetchStaffNewsListService(params);
